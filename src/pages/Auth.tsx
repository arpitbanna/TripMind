...
const Auth = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      localStorage.setItem("isLoggedIn", "true");
      localStorage.setItem("userName", "New Traveler");
      toast({
        title: "Account created! 🎉",
        description: "Welcome to TripMind",
      });
      setIsLoading(false);
      navigate("/dashboard");
    }, 1000);
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        ...
        <Link to="/" className="flex items-center gap-2 justify-center mb-8 group">
          <div className="bg-gradient-hero p-3 rounded-lg group-hover:shadow-hover transition-shadow">
          ...
          <TabsContent value="signup">
            <Card className="shadow-hover">
              <CardHeader>
                ...
                <CardDescription>Start your smart travel journey</CardDescription>
              </CardHeader>
              <CardContent>
